...
.nav{position:fixed;left:50%;top:1.25rem;transform:translateX(-50%);width:min(1120px,calc(100% - 1.5rem));z-index:100;display:flex;align-items:center;justify-content:space-between;gap:1rem;padding:.75rem;border:1px solid var(--line);border-radius:999px;background:var(--nav);box-shadow:var(--shadow);backdrop-filter:var(--glass)}.brand{display:flex;align-items:center;gap:.7rem;border:0;background:transparent;color:var(--text);font-weight:850}.brand span{width:2.35rem;height:2.35rem;display:grid;place-items:center;border-radius:999px;background:linear-gradient(135deg,#020617,#6d28d9,#d946ef);color:white}.nav-links{display:flex;align-items:center;gap:.35rem}.nav-links button{border:0;border-radius:999px;padding:.72rem 1rem;color:var(--muted);background:transparent;font-weight:700;font-size:.88rem}.nav-links button:hover{background:var(--soft);color:var(--text)}.nav-actions{display:flex;gap:.5rem}.work-btn{border:0;border-radius:999px;padding:.72rem 1rem;background:linear-gradient(135deg,#7c3aed,#d946ef);color:white;font-weight:850}.theme-btn{width:2.55rem;height:2.55rem;display:grid;place-items:center;border-radius:999px;background:var(--card2);color:var(--text);border:1px solid var(--line)}
